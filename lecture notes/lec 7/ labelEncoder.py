...
print("Logistic Score is ", mymodel.score(X_test, y_test))
# Gaussian
mymodel = GaussianNB()
mymodel.fit(X_train, y_train)
print("Gaussian score is", mymodel.score(X_test, y_test))
...
mymodel.fit(X_train, y_train)
print("Multi score is", mymodel.score(X_test, y_test))
